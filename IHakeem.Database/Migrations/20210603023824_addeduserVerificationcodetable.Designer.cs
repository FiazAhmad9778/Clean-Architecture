...
namespace iHakeem.Database.Migrations
{
    ...
    [Migration("20210603023824_addeduserVerificationcodetable")]
    partial class addeduserVerificationcodetable
    {
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.MyPhysicians", b =>
                {
                    ...
                    b.Property<long?>("PhysicianPhoneNo")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.CurrentMedication", b =>
                {
                    b.HasOne("iHakeem.Domain.Models.Patient", "PatientDetails")
                        .WithOne()
                        .HasForeignKey("iHakeem.Domain.Models.CurrentMedication", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.ExerciseHistory", b =>
                {
                    b.HasOne("iHakeem.Domain.Models.Patient", "PatientDetails")
                        .WithOne()
                        .HasForeignKey("iHakeem.Domain.Models.ExerciseHistory", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.MyPhysicians", b =>
                {
                    b.HasOne("iHakeem.Domain.Models.Patient", "PatientDetails")
                        .WithOne()
                        .HasForeignKey("iHakeem.Domain.Models.MyPhysicians", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.PatientMedicalHistory", b =>
                {
                    b.HasOne("iHakeem.Domain.Models.Patient", "PatientDetails")
                        .WithOne()
                        .HasForeignKey("iHakeem.Domain.Models.PatientMedicalHistory", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.RecreationalDrugsHistory", b =>
                {
                    b.HasOne("iHakeem.Domain.Models.Patient", "PatientDetails")
                        .WithOne()
                        .HasForeignKey("iHakeem.Domain.Models.RecreationalDrugsHistory", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.SocialHistory", b =>
                {
                    b.HasOne("iHakeem.Domain.Models.Patient", "PatientDetails")
                        .WithOne()
                        .HasForeignKey("iHakeem.Domain.Models.SocialHistory", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iHakeem.Domain.Models.SurgicalHistory", b =>
                {
                    b.HasOne("iHakeem.Domain.Models.Patient", "PatientDetails")
                        .WithOne()
                        .HasForeignKey("iHakeem.Domain.Models.SurgicalHistory", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
